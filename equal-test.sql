...
(5, '2024_03_20_011603_create_transactions_table', 1),
(6, '2024_03_20_034528_add_stock_to_transactions_table', 2);
...
CREATE TABLE `transactions` (
  `id` bigint UNSIGNED NOT NULL,
  `type` enum('pembelian','penjualan') COLLATE utf8mb4_unicode_ci NOT NULL,
  `date` date NOT NULL,
  `qty` int NOT NULL,
  `cost` int NOT NULL,
  `price` int NOT NULL,
